...
export class aioptusWebviewManager<T extends aioptusWebview<S>, S> {
  constructor(
  ...
  private createWebview(
    ...
    const aioptusWebView = new this.webviewType_(context, this.server_, state, previewPanel);
    return aioptusWebView;
  }
...
export abstract class aioptusWebview<T> extends Disposable {
  ...
  public constructor(
    ...
    private readonly _server: aioptusViewServer,
    state: T,
    webviewPanel: HostWebviewPanel
  ) {
    super();
