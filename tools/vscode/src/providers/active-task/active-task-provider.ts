...
export function activateActiveTaskProvider(
  aioptusEvalManager: aioptusEvalManager,
  context: ExtensionContext
): [Command[], ActiveTaskManager] {
  const activeTaskManager = new ActiveTaskManager(context);

  const commands = [
    new RunActiveTaskCommand(activeTaskManager, aioptusEvalManager),
    new DebugActiveTaskCommand(activeTaskManager, aioptusEvalManager),
  ];
