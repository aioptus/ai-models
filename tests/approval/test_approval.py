...
from aioptus.approval import ApprovalDecision, ApprovalPolicy, auto_approver
from aioptus.dataset import Sample
from aioptus.log._log import EvalLog
from aioptus.log._transcript import ApprovalEvent, ToolEvent
...
def test_approve_modify():
    ...
    event = check_approval(
        "modify.yaml",
        decision="modify",
        approver="aioptuspackage/renamer",
    )
