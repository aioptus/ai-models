...
from aioptus.scorer import Score, Scorer, Target, accuracy, includes, scorer
from aioptus.scorer._scorer import scorer_create
...
def test_score_package_name():
    ...
    from aioptuspackage import simple_score
