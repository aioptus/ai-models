...
from aioptus._display.core.textual import textual_enable_mouse_support
from aioptus._util.html import as_html_id
from aioptus.log._samples import active_samples
from aioptus.log._transcript import InputEvent, transcript
...
from .theme import aioptusdark, aioptuslight
...
class TaskScreenApp(App[TR]):
    ...
    def on_mount(self) -> None:
        ...
        self.register_theme(aioptusdark)
        self.register_theme(aioptuslight)
        self.theme = "aioptus-dark"
