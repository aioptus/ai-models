...
from aioptus._eval.task.util import task_file, task_run_dir
from aioptus._util.decorator import parse_decorators
from aioptus._util.error import PrerequisiteError
from aioptus._util.logger import warn_once
from aioptus._util.path import chdir_python
...
from aioptus.model import Model, ModelName
from aioptus.solver._solver import Solver, SolverSpec
from aioptus.util import SandboxEnvironmentSpec, SandboxEnvironmentType
from aioptus.util._sandbox.environment import resolve_sandbox_environment
...
def load_module(
    ...
    if module_path.suffix == ".py":
        ...
        try:
            from aioptus._util.notebook import NotebookLoader
        except ImportError:
            return None
