...
from aioptus.dataset._dataset import Sample
...
from aioptus.model._call_tools import tools_info
from aioptus.model._model import sample_total_tokens
from aioptus.tool import Tool, ToolChoice
from aioptus.tool._tool_def import ToolDef
from aioptus.util._store import Store, store_jsonable
...
class TaskState:
    ...
    def message_limit(self, messages: int | None) -> None:
        ...
        from aioptus.log._samples import set_active_sample_message_limit
    ...
    def token_limit(self, tokens: int | None) -> None:
        ...
        from aioptus.log._samples import set_active_sample_token_limit
    ...
    def completed(self) -> bool:
        ...
        # update messages
        from aioptus.log._samples import set_active_sample_total_messages
        from aioptus.log._transcript import SampleLimitEvent, transcript
