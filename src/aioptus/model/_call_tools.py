...
from aioptus._util.text import truncate_string_to_bytes
from aioptus.model._trace import trace_tool_mesage
from aioptus.tool import Tool, ToolCall, ToolError, ToolInfo
from aioptus.tool._tool import (
    ToolApprovalError,
    ToolParsingError,
)
from aioptus.tool._tool_call import ToolCallContent, ToolCallError
from aioptus.tool._tool_def import ToolDef, tool_defs
from aioptus.tool._tool_info import parse_docstring
from aioptus.tool._tool_params import ToolParams
from aioptus.util import OutputLimitExceededError
...
async def call_tool(tools: list[ToolDef], message: str, call: ToolCall) -> Any:
    ...
    from aioptus.approval._apply import apply_tool_approval
...
def tool_params(input: dict[str, Any], func: Callable[..., Any]) -> dict[str, Any]:
    ...
    signature = aioptus.signature(func)
    type_hints = get_type_hints(func)
    docstring = aioptus.getdoc(func)
