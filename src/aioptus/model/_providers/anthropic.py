...
from aioptus._util.constants import BASE_64_DATA_REMOVED, DEFAULT_MAX_RETRIES
from aioptus._util.content import Content, ContentText
from aioptus._util.error import exception_message
from aioptus._util.images import image_as_data_uri
from aioptus._util.logger import warn_once
from aioptus._util.url import data_uri_mime_type, data_uri_to_base64, is_data_uri
from aioptus.tool import ToolCall, ToolChoice, ToolFunction, ToolInfo
...
async def resolve_chat_input(
    ...
    # collapse user messages (as aioptus 'tool' messages become Claude 'user' messages)
