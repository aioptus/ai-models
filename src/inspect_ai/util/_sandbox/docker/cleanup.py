            ...
            if cleanup:
                ...
                for project in shutdown_projects:
                    ...
                    table.add_row(
                        ...
                        f"[blue]aioptus sandbox cleanup docker {project.name}[/blue]",
                    )
                print(table)
                print(
                    "\nCleanup all environments with: [blue]aioptus sandbox cleanup docker[/blue]\n"
                )
...
async def cli_cleanup(project_name: str | None) -> None:
    # enumerate all aioptus projects
