...
SERVICES_DIR = "/tmp/aioptus-sandbox-services"
...
class SandboxService:
    ...
    for calling back into the main aioptus process.
    ...
    ```python
    import sys
    sys.path.append("/tmp/aioptus-sandbox-services/foo")
    import foo
    ```
    ...
    spec = importlib.util.spec_from_file_location(
        "foo", "/tmp/aioptus-sandbox-services/foo/foo.py"
    )
