...
export const FindBand = ({ hideBand }) => {
  ...
  return html`<div
    style=${{
      ...
      marginRight: "20%",
      zIndex: "1060",
      color: "var(--aioptus-find-foreground)",
      backgroundColor: "var(--aioptus-find-background)",
      fontSize: "0.9rem",
      display: "grid",
  ...
  >
    <input
      ...
      margin: "0.1rem",
      outline: "none",
      border: "solid 1px var(--aioptus-input-border)",
      color: "var(--aioptus-input-foreground)",
      background: "var(--aioptus-input-background)",
    }}
      placeholder="Find"
      onkeydown=${(e) => {
      if (e.key === "Escape") {
