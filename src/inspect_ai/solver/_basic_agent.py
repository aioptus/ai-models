...
from aioptus.model._cache import CachePolicy
from aioptus.model._call_tools import call_tools
from aioptus.model._chat_message import ChatMessageTool, ChatMessageUser
from aioptus.model._model import get_model
from aioptus.scorer._metric import Score, ValueToFloat, value_to_float
from aioptus.scorer._score import score
from aioptus.solver._chain import chain
from aioptus.tool._tool import Tool, ToolResult, tool
        ...
        async def solve(state: TaskState, generate: Generate) -> TaskState:
            ...
            while not state.completed:
                ...
                if state.output.stop_reason == "model_length":
                    from aioptus.log._transcript import transcript
