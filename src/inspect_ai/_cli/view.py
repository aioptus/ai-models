...
from aioptus._util.constants import DEFAULT_SERVER_HOST, DEFAULT_VIEW_PORT
from aioptus._view.view import view
...
def start(
    ...
    **common: Unpack[CommonOptions],
    ...
    aioptus_VIEW_AUTHORIZATION_TOKEN = "aioptus_VIEW_AUTHORIZATION_TOKEN"
    authorization = os.environ.get(aioptus_VIEW_AUTHORIZATION_TOKEN, None)
    if authorization:
        del os.environ[aioptus_VIEW_AUTHORIZATION_TOKEN]
        os.unsetenv(aioptus_VIEW_AUTHORIZATION_TOKEN)
